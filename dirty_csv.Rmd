...
Stay away from readr. Make sure to double check you're reading in the complete file. The extra quotes can appear in open fields such as `omschrijving` in the episode table. But I've also had this issue in the med file. 
